...
namespace W8.WPFDevToolkit.UC.PopupControl.Lib
{
    public class PopupSettings
    {
        ...
        public static readonly PopupSettings CenterWideDialog = new PopupSettings(TimeSpan.FromMilliseconds(350), 0.7, 0.5, PopupAnimation.ControlFlip | PopupAnimation.OverlayFade, false);
